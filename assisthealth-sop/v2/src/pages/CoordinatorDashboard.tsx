...
const CoordinatorDashboard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchChapters = async () => {
      const snap = await getDocs(collection(db, 'coordinatorChapters'));
  ...
  return (
    <div className="dashboard-container">
      ...
      <main className="main-content">
        <TopNavbar title="Coordinator Portal" />
        ...
        <div className="page-content">
            ...
            <div className="fade-in">
              ...
              <div className="summary-grid" style={{ gridTemplateColumns: 'repeat(2, 1fr)' }}>
                <div className="summary-card" onClick={() => setActiveTab('sop')}>
                  <div className="summary-card-icon coord-chapters">
                ...
                <div className="summary-card" onClick={() => setActiveTab('sop')}>
                  <div className="summary-card-icon coordinators">
          ...
          {activeTab === 'sop' && (
            <div className="fade-in">
              <div className="page-header">
                <h1>Coordinator SOP Chapters</h1>
